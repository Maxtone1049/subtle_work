...
class DropDownTextField extends StatefulWidget {
  ...
  /// Alrernative text editing controller when a value is not set for the custom text editing controller
  /// [single and multiple] controller
    ...
    return KeyboardVisibilityBuilder(
      builder: (context, isKeyboardVisible) {
        ...
        return CompositedTransformTarget(
          link: _layerLink,
          child: TextFormField(
            controller: widget.textEditingController ?? _cnt,
...
class DropDownValueModel {
  final String name;
  final String? amount, variationCode, cryptoAddress, sellingRate;
  final dynamic value;
