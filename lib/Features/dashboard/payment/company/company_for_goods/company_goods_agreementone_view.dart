...
class CompanyGoodsAgreementView extends StatefulWidget {
  const CompanyGoodsAgreementView({super.key});

  @override
  State<CompanyGoodsAgreementView> createState() =>
      _CompanyGoodsAgreementView();
}

class _CompanyGoodsAgreementView extends State<CompanyGoodsAgreementView> {
  @override
          ...
          child: Column(
            ...
            children: [
              TextView(
                ...
                text: "Pay A Registered Company For Goods",
                fontSize: 18.sp,
                  ...
                  config: ButtonConfig(
                      ...
                      onPressed: () {
                        Navigator.push(
                            ...
                            MaterialPageRoute(
                                builder: ((context) =>
                                    const CompanyGoodPreviewAgreementView())));
                      },
                      height: 42,
                      fontWeight: FontWeight.w400,
