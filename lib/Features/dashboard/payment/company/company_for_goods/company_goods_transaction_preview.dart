...
import 'package:weverefy/Features/dashboard/payment/company/company_for_goods/sheets/company_payments_sheets.dart';
import 'package:weverefy/assets/app_colors.dart';

class CompanyGoodTransactionPreview extends StatelessWidget {
  const CompanyGoodTransactionPreview({super.key});
                    ...
                    config: ButtonConfig(
                        ...
                        onPressed: () {
                          BottomSheets.showSheet(context,
                              child: const CompanyPaymentSheets(
                                serviceType: 'Goods',
                              ));
                        },
                        radius: 10.r,
