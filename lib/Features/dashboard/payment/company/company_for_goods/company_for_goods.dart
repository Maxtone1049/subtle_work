...
class PayCompanyGoods extends StatefulWidget {
  const PayCompanyGoods({super.key});

  @override
  State<PayCompanyGoods> createState() => _PayCompanyGoodsState();
}

class _PayCompanyGoodsState extends State<PayCompanyGoods> {
                    ...
                    config: ButtonConfig(
                      ...
                      onPressed: () {
                        Navigator.push(
                            ...
                            MaterialPageRoute(
                                builder: (context) =>
                                    const CompanyGoodsAgreementView()));
                      },
                      height: 42,
                      fontSize: 12.sp,
                      fontWeight: FontWeight.w400,
