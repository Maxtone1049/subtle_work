...
class PayCompanyService extends StatefulWidget {
  const PayCompanyService({super.key});

  @override
  State<PayCompanyService> createState() => _PayCompanyServiceState();
}

class _PayCompanyServiceState extends State<PayCompanyService> {
              ...
              child: Column(
                ...
                children: [
                  TextView(
                    ...
                    text: "Pay A Registered Company For Services",
                    fontSize: 18.sp,
                  ...
                  TextView(
                      config: TextViewConfig(
                    text: "Company's Account details",
                    fontSize: 12.sp,
                    fontWeight: FontWeight.w400,
                    color: AppColors.black,
                  )),
