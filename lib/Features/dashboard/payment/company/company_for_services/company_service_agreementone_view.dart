...
class CompanyServiceAgreement extends StatefulWidget {
  const CompanyServiceAgreement({super.key});

  @override
  State<CompanyServiceAgreement> createState() =>
      _CompanyServiceAgreementState();
}

class _CompanyServiceAgreementState extends State<CompanyServiceAgreement> {
  @override
                  ...
                  config: ButtonConfig(
                      ...
                      onPressed: () {
                        Navigator.push(
                            ...
                            MaterialPageRoute(
                                builder: ((context) =>
                                    const CompanyServicePreviewAgreement())));
                      },
                      height: 42,
                      fontWeight: FontWeight.w400,
