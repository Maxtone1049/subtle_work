...
import 'package:weverefy/Features/dashboard/payment/individual/individual_for_services/service_transaction_preview.dart';
...
class PreviewServiceAgreement extends StatelessWidget {
  const PreviewServiceAgreement({super.key});
                      ...
                      config: ButtonConfig(
                          ...
                          onPressed: () {
                            Navigator.push(
                                ...
                                MaterialPageRoute(
                                    builder: (context) =>
                                        const ServiceTransactionPreview()));
                          },
                          height: 42,
